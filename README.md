Cappusance is a powerful GUI builder for Cappuccino with strong autolayout capabilities. Cappusance is actually a port of <[http://www.gnustep.it/Renaissance](https://github.com/gnustep/libs-renaissance)>.
